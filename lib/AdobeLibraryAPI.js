...
/**
 * Create a FolioActivityConfig object.
 * 
...
function FolioActivityService() {	
	...
	/**
	 * The supported event names.  These can be used to filter for desired events by setting the
	...
	/**
	 * The supported event attributes.  These are the keys that will be present in the
	 * event objects return by <em>getEvents()</em>.
	 * 
	 * @memberOf adobeDPS-FolioActivityService.prototype
	 * @type Array
	 */
