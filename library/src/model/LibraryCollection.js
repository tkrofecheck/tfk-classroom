...
App.model.LibraryCollection = Backbone.Collection.extend({
	...
	parse: function(xml) {
		...
		if (len > 0) {
			...
			for (var i = 0; i < len; i++) {
				...
				issue.productId = attributes.getNamedItem("productId") ? attributes.getNamedItem("productId").value : App.model.LibraryCollection.productIdCounter++;
...
App.model.LibraryCollection.productIdCounter = 1;
